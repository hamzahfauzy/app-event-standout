        ...
        <div class="row mt-4">
            <div class="col-sm-12 col-md-6 col-lg-4 mx-auto">
                ...
                <div class="card full-height">
                    <div class="card-body">
                        <center>
                            <img src="<?=asset('assets/img/main-logo.png')?>" width="150px" height="100px" alt="logo" style="object-fit:contain;">
                        </center>
                        ...
                        <form action="" method="post">
                            <div class="form-group">
                                ...
                                <center>
                                    atau klik <a href="<?=routeTo('auth/register')?>">disini</a> untuk mendaftar
                                </center>
                            </div>
                        </form>
                    </div>
